...
export function MetadataSidebar({
  ...
  return (
    <aside className="grid gap-4 rounded-[1.75rem] border border-white/8 bg-black/15 p-5">
      <div>
      ...
      <label className="grid gap-2 text-sm text-planka-text-muted">
        ...
        <select
          ...
          className="rounded-2xl border border-white/10 bg-black/20 px-4 py-3 text-planka-text outline-none disabled:opacity-60"
        >
